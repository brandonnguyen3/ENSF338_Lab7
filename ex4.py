...
class BinarySearchTree:
        ...
        if self.pivot is None:
            ...
            if pivotBalance >= 1:
                ...
                if nodeInserted.key < self.pivot.key:
                    ...
                    if nodeInserted.key > self.pivot.key and self.getBalance(parent) == -2:
    ...
    def _lr_rotate(self, pivot):
        self._right_rotate(pivot.left)
        self._left_rotate(pivot)

# RL rotation method
    def _rl_rotate(self, pivot):
        self._left_rotate(pivot.right)
...
def testFive():
    ...
    AVLTest.insert(95)  
    AVLTest.insert(80)  
    AVLTest.insert(85)  # Test Case 3b: Triggering case 3b
    AVLTest.insert(86)  # Test Case 3b: Triggering case 3b
    AVLTest.insert(87)  # Test Case 3b: Triggering case 3b
...
print("\n")
testFour()
print("End of Test four")
print("\n")
testFive()
print("End of Test Six")
print("\n")
testSix()
print("End of Test Seven")
print("\n")
